...
function generateItems(today) {
  ...
  return [
    ...
    {
      id: 2,
      title: "Papers review with Tonny.",
      date: randomDate(addMinutes(today, -60), addMinutes(today, 60)),
    },
    { id: 3, title: "Annual party at Eric's house.", date: randomDate() },
    { id: 4, title: "Last day to pay off auto credit.", date: randomDate() },
    {
      id: 5,
      title: "Call and schedule another meeting with Amanda.",
      date: randomDate(addMinutes(today, -360), addMinutes(today, 360)),
    },
    {
      id: 6,
      title: "Don't forget to send in financial reports.",
      date: randomDate(),
    },
  ];
}
